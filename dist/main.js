...
function creationTime() {
  const now = Date.now();
  const formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(now, "yyyy-MM-dd");
  return formatedDate;
}
